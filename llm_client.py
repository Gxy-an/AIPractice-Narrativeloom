    ...
    *,
    ...
    if lang == "en":
        ...
        system = (
            ...
            "以故事质量为最高优先级：设定要有具体时间地点与感官细节；人物须写清姓名、动机、关系及在本节中的行动驱动；"
            "因果清晰、避免空泛套话与口号式描写。"
    ...
    *,
    ...
    if lang == "en":
        system = (
            ...
            "Target about 500–1000 words unless the outline is tiny. No JSON or bullet meta. "
        ...
        system = (
            ...
            "篇幅目标约 900～1800 字（概述极短时可略短但仍须明显长于概述原文）。"
